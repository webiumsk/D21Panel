    ...
    public static function getAllChecklistItems(): array
    {
        return [
            ...
            'blitz' => [
                'connect_wallet' => [
                    'key' => 'connect_wallet',
                    'description' => 'Confirm Blitz Wallet connection is active (Wallet connection - status should show configured or pending → connected)',
                    'link' => null,
                    'order' => 1,
                ],
                'enable_lightning' => [
                ...
                'test_invoice' => [
                    'key' => 'test_invoice',
                    'description' => 'Create a small test invoice or PoS payment to verify payouts arrive in Blitz',
                    'link' => null,
                    'order' => 3,
                ],
            ],
            'flash' => [
                'connect_wallet' => [
                    'key' => 'connect_wallet',
                    'description' => 'Confirm Flash Wallet connection is active (Wallet connection - status should show configured or pending → connected)',
                    'link' => null,
                    'order' => 1,
                ],
                'enable_lightning' => [
                ...
                'test_invoice' => [
                    'key' => 'test_invoice',
                    'description' => 'Create a small test invoice or PoS payment to verify payouts arrive in Flash',
                    'link' => null,
                    'order' => 3,
                ],
            ],
